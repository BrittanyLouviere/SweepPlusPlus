function standoff_extrude_4_outline_fn(){
    return CAG.circle({"center":[207,-102.5],"radius":3.16})
.union(
...
function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[207,-102.5],"radius":1.5})
.union(
...
function xlBoard_extrude_1_outline_fn(){
    return new CSG.Path2D([[87,-107.8878697],[87,-40.0691011]]).appendArc([89.1480211,-35.9622512],{"radius":5,"clockwise":true,"large":false}).appendPoint([105.4412471,-24.6475109]).appendArc([106.9550066,-23.9367713],{"radius":5,"clockwise":true,"large":false}).appendPoint([124.0707055,-19.1824105]).appendArc([125.4089249,-19],{"radius":5,"clockwise":true,"large":false}).appendPoint([146.8287417,-19]).appendArc([147.3977482,-19.0324824],{"radius":5,"clockwise":true,"large":false}).appendPoint([199.5690066,-25.0084628]).appendArc([204,-29.9759805],{"radius":5,"clockwise":true,"large":false}).appendPoint([204,-62.3348873]).appendArc([204.0937,-62.7575222],{"radius":1,"clockwise":false,"large":false}).appendPoint([227.0116527,-111.902881]).appendArc([226.8102795,-116.5160554],{"radius":5,"clockwise":true,"large":false}).appendPoint([218.165383,-131.4894553]).appendArc([212.8626105,-133.893939],{"radius":5,"clockwise":true,"large":false}).appendPoint([142.6959669,-119.9786555]).appendArc([142.6390063,-119.9690599],{"radius":1,"clockwise":false,"large":false}).appendPoint([91.3121581,-112.840331]).appendArc([87,-107.8878697],{"radius":5,"clockwise":true,"large":false}).close().innerToCAG()
