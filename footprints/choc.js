...
module.exports = {
  ...
  body: p => {
    const standard = `
      ...
      ${''/* middle shaft */}
      (pad "" np_thru_hole circle (at 0 0) (size 3.429 3.429) (drill 3.429) (layers Dwgs.User))
        
      ${''/* stabilizers */}
      (pad "" np_thru_hole circle (at 5.5 0) (size 1.7018 1.7018) (drill 1.7018) (layers Dwgs.User))
      (pad "" np_thru_hole circle (at -5.5 0) (size 1.7018 1.7018) (drill 1.7018) (layers Dwgs.User))
      `
    const keycap = `
      ${'' /* keycap marks */}
    ...
    function pins(def_neg, def_pos, def_side) {
      if(p.hotswap) {
        var x = `
          ...
          ${'' /* holes */}
          (pad "" np_thru_hole circle (at ${def_pos}5 -3.75) (size 3 3) (drill 3) (layers Dwgs.User) (clearance 0.001))
        `
        
        if(def_side == 'B')
          x +=  `(pad "" np_thru_hole circle (at 0 -5.95) (size 3 3) (drill 3) (layers Dwgs.User))`
